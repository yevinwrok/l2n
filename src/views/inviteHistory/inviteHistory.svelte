...
<div class="invite_total">
  <div class="invite_total_item block_full">
    <ITL num="1000" text="下级总人数(人)" />
    <ITL num="1000" text="下级用户数(人)" />
    <ITL num="1000" text="下级技师数(人)" />
  </div>
  <div class="invite_total_item block_full">
    <ITL num="1000" text="邀请总收益(元)" />
    <ITL num="1000" text="邀请用户收益(元)" />
    <ITL num="1000" text="邀请技师收益(元)" />
  </div>

  <div class="invite_total_item block">
    <ITL num="1000" text="下单用户数(人)" />
  </div>
  <div class="invite_total_item block">
    <ITL num="66%" text="下单用户占比" />
  </div>
  <div class="invite_total_item block">
    <ITL num="1000" text="接单技师数(人)" />
  </div>
  <div class="invite_total_item block">
    <ITL num="1000" text="接单用户占比" />
  </div>
</div>
